                  ...
                  <tr>
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <p>Thank you for joining the Operation Braveheart Social Club Lottey.</p>
                        <p>You have been allocated the lottery number <b>{{$player->lottery_number}}</b>.</p>
                        <p>David will be in contact soon about taking your subscrition payment whic will then enter YOU into the monthly draw.</p>
